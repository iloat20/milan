 ...
 */
class EconomyService(private val core: ServiceCore) : EconomyApi {
     ...
     * 另一入口可插入并通过过期校验 → 负余额）。
     */
    override suspend fun buyFragmentPack(pack: Int): WriteOutcome = core.withWriteLock {
     ...
     */
    override suspend fun exchangeFragmentsForSoft(): WriteOutcome = core.withWriteLock {

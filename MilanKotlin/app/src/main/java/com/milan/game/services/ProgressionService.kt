...
internal class ProgressionService(private val core: ServiceCore) {
     ...
     */
    suspend fun levelUp(charId: String, n: Int = 1): WriteOutcome = core.withWriteLock {
     ...
     */
    suspend fun grantExp(charId: String, amount: Int): Int = core.withWriteLock {
    ...
    suspend fun ascend(charId: String): WriteOutcome = core.withWriteLock {
        val save = core.getSave(charId) ?: return@withWriteLock WriteOutcome.Rejected
    ...
    suspend fun starUp(charId: String): WriteOutcome = core.withWriteLock {
        val save = core.getSave(charId) ?: return@withWriteLock WriteOutcome.Rejected
        val def = core.character(charId) ?: return@withWriteLock WriteOutcome.Rejected
    ...
    suspend fun allocateTalent(charId: String, nodeId: String): WriteOutcome = core.withWriteLock {
